  ...
  <section class="content">
  	<div class="row">
  	  ...
  	  <div class="col-md-10">
		  ...
		  <!-- 发布公告表单 -->
		  <form action="releaseNotice" method="post" id="releaseNoticeForm" role="form">
			<!-- 盒子头部 -->
			...
			<div class="box-body">
				...
				<div class="form-group">
				  <label>内容</label>
				  <textarea name="content" class="form-control" rows="5" placeholder="输入内容 ..."></textarea>
				</div>
				
			</div>
			<div class="box-footer">
				<a href="noticeList" class="btn btn-default">公告列表</a>
				<button type="submit" class="btn btn-info pull-right">发布公告</button>
		    </div>
		  </form>
...
$(document).ready(function() {
     ...
     * 表单校验
     * */
    $('#releaseNoticeForm').bootstrapValidator({
